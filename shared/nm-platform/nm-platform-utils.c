...
#define ETHT_FEAT(eid, ...)                                        \
    ...
    ETHT_FEAT(NM_ETHTOOL_ID_FEATURE_NETNS_LOCAL, "netns-local"),
    ...
    ETHT_FEAT(NM_ETHTOOL_ID_FEATURE_TX_LOCKLESS, "tx-lockless"),
    ...
    ETHT_FEAT(NM_ETHTOOL_ID_FEATURE_VLAN_CHALLENGED, "vlan-challenged"),
};
